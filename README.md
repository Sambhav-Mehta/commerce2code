...
- `variables.py` — Clean, runnable Python script
- `variables_interactive.ipynb` — Interactive Jupyter notebook (view on GitHub)
- Google Colab link — Edit and run code in your browser (no setup needed)
